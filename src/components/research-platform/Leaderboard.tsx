    ...
    const fetchLeaderboardData = async () => {
      ...
      try {
        ...
        setLeaderboardData({
          ...
          papers: [
            { id: '2', name: 'Prof. Michael Rodriguez', avatar: '/placeholders/team-member-2.svg', score: 8, change: 'up', badge: 'gold' },
            { id: '1', name: 'Dr. Sarah Chen', avatar: '/placeholders/team-member-1.svg', score: 6, change: 'up', badge: 'silver' },
            { id: '4', name: 'Dr. James Wilson', avatar: '/placeholders/team-member-4.svg', score: 5, change: 'down', badge: 'bronze' },
            { id: '3', name: 'Dr. Aisha Patel', avatar: '/placeholders/team-member-3.svg', score: 4, change: 'up', badge: null },
            { id: '5', name: 'Dr. Emily Zhang', avatar: '/placeholders/team-member-1.svg', score: 3, change: 'down', badge: null },
          ],
          datasets: [
            { id: '3', name: 'Dr. Aisha Patel', avatar: '/placeholders/team-member-3.svg', score: 12, change: 'up', badge: 'gold' },
            { id: '4', name: 'Dr. James Wilson', avatar: '/placeholders/team-member-4.svg', score: 9, change: 'up', badge: 'silver' },
            { id: '1', name: 'Dr. Sarah Chen', avatar: '/placeholders/team-member-1.svg', score: 7, change: 'down', badge: 'bronze' },
            { id: '5', name: 'Dr. Emily Zhang', avatar: '/placeholders/team-member-1.svg', score: 5, change: 'up', badge: null },
            { id: '2', name: 'Prof. Michael Rodriguez', avatar: '/placeholders/team-member-2.svg', score: 4, change: 'down', badge: null },
          ],
          experiments: [
            { id: '1', name: 'Dr. Sarah Chen', avatar: '/placeholders/team-member-1.svg', score: 24, change: 'up', badge: 'gold' },
            { id: '3', name: 'Dr. Aisha Patel', avatar: '/placeholders/team-member-3.svg', score: 18, change: 'up', badge: 'silver' },
            { id: '5', name: 'Dr. Emily Zhang', avatar: '/placeholders/team-member-1.svg', score: 15, change: 'up', badge: 'bronze' },
            { id: '2', name: 'Prof. Michael Rodriguez', avatar: '/placeholders/team-member-2.svg', score: 12, change: 'down', badge: null },
            { id: '4', name: 'Dr. James Wilson', avatar: '/placeholders/team-member-4.svg', score: 10, change: 'down', badge: null },
          ],
        });
      } finally {
        setLoading(false);
